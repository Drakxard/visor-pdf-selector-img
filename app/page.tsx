...
export default function Home() {
  ...
  const handleSaveGroqConfig = useCallback(() => {
    ...
    const trimmedImagePrompt = groqImagePrompt.trim() || DEFAULT_GROQ_IMAGE_PROMPT
    setGroqSaving(true)
    try {
      setStoredItem(
  ...
  }, [groqImagePrompt, groqModel, groqPrompt, showToastMessage])
        ...
        >
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium" htmlFor="groq-prompt">
              Prompt para selecciones (detalles)
            </label>
            <textarea
              id="groq-prompt"
              value={groqPrompt}
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium" htmlFor="groq-image-prompt">
              Prompt para la selección principal (imagen)
            </label>
            <textarea
